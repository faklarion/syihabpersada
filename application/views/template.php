...
<html>
    <head>
        ...
        <title>SYIHAB PERSADA INDONESIA</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a class="logo">
                    ...
                    <span class="logo-lg"><b>SYIHAB PERSADA</b></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">                          
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <?php } elseif($this->session->userdata('images') == NULL) { ?>
                                        <img src="<?php echo base_url() ?>assets/images/ppkosong.jpg" class="user-image" alt="User Image">
                                    <?php } elseif($this->session->userdata('images') == '')  { ?>
                                        <img src="<?php echo base_url() ?>assets/images/ppkosong.jpg" class="user-image" alt="User Image">
                                    <?php }?>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; <?php echo date('Y')?> Syihab Persada Indonesia</a>.</strong> All rights
                reserved.
            </footer>
