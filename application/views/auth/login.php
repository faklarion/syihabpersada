...
<html>
    ...
    <body>
        <div class="login-box" style="overflow: hidden; height: 100%; margin-top: 2%; ">
            <div class="login-logo">
                
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body" style="border-radius: 10px;">
            <p class="text-center"><img style="border-radius: 10px;" src="<?php echo base_url(); ?>assets/images/logopersada.jpg" alt=""></p>
                <?php
                ...
                ?>
                <b><p class="login-box-msg"><?php echo $message; ?></p></b>
